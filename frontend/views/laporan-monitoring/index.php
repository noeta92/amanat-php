...
<div class="pegawai-index">
    ...
    <?php 
        $urutBatal = Html::a('<span class="fas fa-times"></span> Urutkan', ['index'], ['class' => 'btn btn-xs btn-outline-danger']);
            ...
            <table class = "table table-responsive table-bordered table-hover">
                <?php if ($start != NULL) : ?>
                    <div class="alert alert-light" role="alert">
                        <span class="fas fa-chart-line"> </span> Laporan dari tanggal <strong> <?= $start ?> </strong> <strong> sampai dengan <?= $end ?> </strong>
                    </div>    
                <?php elseif  ($start == NULL) : ?>
                    <div class="alert alert-light" role="alert">
                        <span class="fas fa-chart-line"> </span> Laporan Monitoring Keseluruhan    
                <?php endif; ?>
                <tr> 
                ...
                <?php } 
                    foreach ($modelPegawai as $keyPegawai => $valuePegawai) : ?>
