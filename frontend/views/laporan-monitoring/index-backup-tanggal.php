...
<div class="pegawai-index">
    ...
    <h3>Laporan dari tanggal <?=$start; ?> sampai dengan <?=$end?> </h3>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model) use($start,$end) {
                    ...
                    $perjadin = $model->getMonitoringPerjadins()->andwhere(['between', 'tanggal_awal' , $start, $end])->count();
                    return $perjadin;
            ...
            [
                ...
                'value' => function ($model) use($start,$end) {
                    ...
                    $perjadin = $model->getMonitoringLemburs()->andwhere(['between', 'tanggal_awal' , $start, $end])->count();
                    return $perjadin;
            ...
            [
                ...
                'value' => function ($model) use($start,$end) {
                    ...
                    $perjadin = $model->getMonitoringHonoraria()->andwhere(['between', 'tanggal' , $start, $end])->count();
                    return $perjadin;
