...
<div class="pegawai-index">
    ...
    if ($start == NULL) {
        ...
        $urutHonor = Html::a('<span class="fas fas fa-arrow-alt-circle-up"></span> Urutkan', ['honorarium'], ['class' => 'btn btn-xs btn-outline-primary']); 
    } else {
        ...
        $urutHonor = Html::a('<span class="fas fas fa-arrow-alt-circle-up"></span> Urutkan', ['honorarium', 'start'=> $start, 'end'=>$end], ['class' => 'btn btn-xs btn-outline-primary']);     
    } 
    ?>
    ...
    <div class ="card">
        <div class="card-body">
            ...
            'method' => 'post',
            'action' => ['laporan-monitoring/lembur'],
            ]); ?>
            ...
            <?php if ($start == null) { ?>
                ...
                <br> <?= Html::submitButton('Hitung Lembur', ['class' => 'btn btn-outline-primary']) ?>
                <?php ActiveForm::end();  ?>  
            </div> 
            <hr>
            ...
            <?php if ($start != NULL) : ?>
                    <div class="alert alert-light" role="alert">
                        <span class="fas fa-chart-line"> </span> <strong> Urutan Lembur </strong> dari tanggal <strong> <?= $start ?> </strong> <strong> sampai dengan <?= $end ?> </strong>
                    </div>    
                <?php elseif  ($start == NULL) : ?>
                    <div class="alert alert-light" role="alert">
                        <span class="fas fa-chart-line"> </span> <strong> Urutan Lembur </strong> Keseluruhan    
                <?php endif; ?>
                <tr> 
                    <th style="color:#047bfb">Nama Pegawai</th>
                    <th style="color:#047bfb">Lembur <?= $urutBatal ?></th>
