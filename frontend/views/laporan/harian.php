        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                [
                 ...
                 // 'template' => (Helper::checkRoute('laporan/update-bagian') ? ' {update-bagian}' : '').(Helper::checkRoute('laporan/update') ? ' {update}' : ''),
                  'buttons' => [
                    ...
                    'update-bagian' => function ($url, $model) {
                  ...
                  'urlCreator' => function ($action, $model, $key, $index) {
                    ...
                    if ($action === 'update') {
                        $url ='index.php?r=laporan/update&id='.$model->id;
                        return $url;
                    }

                    if ($action === 'update-bagian') {
                      $url ='index.php?r=laporan/update-bagian&id='.$model->id;
                      return $url;
