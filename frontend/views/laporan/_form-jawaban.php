...
?>
        ...
        <div class="ref-sektor-form">
            ...
            <div class="col-md-6">
                ...
                Untuk menjawab aduan dan merubah penyelesaian aduan Silahkan Isi dibawah ini!
                </div>
            ...
            <?php // echo $form->field($model, 'kodeBagian')->dropDownList($bagian, ['prompt'=>'Pilih Bagian', 'id'=> 'kodeBagian'])?>
