			...
			<div class="pengaduan-update">
			    ...
			    <table class="table table-striped table-bordered" id="sample_1">
				    ...
				    elseif ($model->statusAduan == 2) {
				    	...
				    	echo "<strong>Status: <font color= 'green'> Sudah Dijawab </font> <br> 
				    				  Status Verifikasi: <font color= 'warning'> Revisi Penyelesaian !</font></strong>";
				    }
				    ?>
					</p>
				    ...
				    <tr>
				    	...
				    	<th> <?php
	                        ...
	                        foreach ($foto as $value) {
	                           ...
	                           $tombols .= Html::a("Lihat", ["lihat-file","nama_file"=>$namaFile], ['role'=>'modal-remote', 'class'=>"btn bg-navy"]).'<br>'; 
	                        }
				    ...
				    <tr>
				    	<th> Dokumen Penyelesaian : </th> <th> </th>
				    </tr>	
