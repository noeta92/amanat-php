...
$script = <<< JS
      $("#jenis").on("change", function() {
        var dataJenis = $('input:radio[name="MonitoringLembur[jenisSurat]"]:checked').val()
...
<div class="monitoring-lembur-form">
    ...
    <div class="card">
        ...
        <div class = "row">
            ...
            <?= $form->field($model, 'jenisPerjalanan')->radioList( [0=>'Dinas Biasa', 1 => 'Dalam Kota', 2 => 'Lembur'], ['unselect' => null] )->label('Jenis Kegiatan'); ?>
