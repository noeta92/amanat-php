...
<div class="surat-masuk-form">
   ...
   <?php  
    $buttonTerima = 
    Html::button('<span class="fas fa-check-circle"></span> Terima', ['value'=>Url::to(['monitoring-lembur/verifikasi','idLembur'=> $model['idLembur'], $status=1]), 'class'=>'modalButton btn btn-md btn-success']);
    
    $buttonTolak = 
    Html::button('<span class="fas fa-times-circle"></span> Tolak', ['value'=>Url::to(['monitoring-lembur/verifikasi','idLembur'=> $model['idLembur'], $status=2]), 'class'=>'modalButton btn btn-md btn-danger']);
    ?>
